...
current_version = os.environ.get("CURRENT_BRANCH") or (
    ALL_VERSIONS[0] if ALL_VERSIONS else "main"
)
...
html_context["versions"] = [(v, f"{GITHUB_PAGES_BASE}/{v}/") for v in ALL_VERSIONS]
